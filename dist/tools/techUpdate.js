...
const TOPIC_DEFINITIONS = [
    {
        ...
        focus: "Highlight launch details, differentiating capabilities, availability, and early adoption signals.",
        keywords: ["newmodels", "modelrelease", "modelreleases", "latestmodels"],
    },
    {
        slug: "aiProductUpdates",
        title: "AI Product & Platform Updates",
        description: "Significant product announcements, roadmap changes, or integrations across AI platforms.",
        focus: "Summarize new features, integrations, or pricing/rollout notes impacting builders or enterprises.",
        keywords: [
            "aiproductupdates",
            "productupdates",
            "platformupdates",
    ...
    },
    {
        ...
        focus: "Call out core findings, performance metrics, and implications for practitioners.",
    ...
    },
    {
        ...
        focus: "Summarize regulatory actions, standards proposals, or industry pledges with practical impact.",
        keywords: [
            "polethicsandsafety",
            "polethicsafety",
            "policyethics",
    ...
    },
    {
        ...
        focus: "Note dates, headlining announcements, and why the event matters for practitioners.",
        keywords: [
            "upcomingevents",
            "aievents",
            "techevents",
...
function buildPrompt(definition) {
    return `You are an AI technology news analyst. Provide a concise, timely update focused on ${definition.title}.
...
export const getTechUpdateTool = {
    definition: {
        ...
        description: "Get a concise, citation-rich update on the latest AI and technology developments for a specific topic.",
        inputSchema: {
            ...
            properties: {
                topic: {
                    type: "string",
                    description: "Topic focus for the update. Supported values: newModels, aiProductUpdates, techResearch, polEthicsAndSafety, upcomingEvents.",
                },
            },
            required: ["topic"],
        },
    ...
    handler: async (args) => {
        ...
        if (!topicDefinition) {
            throw new McpError(ErrorCode.InvalidParams, "Unsupported topic for get_tech_update. Choose one of: newModels, aiProductUpdates, techResearch, polEthicsAndSafety, upcomingEvents.");
        }
